...
function LRButton({ className, onKeyDown, onKeyUp, button }: LRButtonProps) {
  return (
    <div
      className={clsx(
        className,
        "bg-slate-800 rounded-full w-20 h-12 sm:w-32 sm:h-16 text-white grid place-items-center text-2xl sm:text-5xl select-none active:bg-slate-500 border-8 border-orange-700",
        {
